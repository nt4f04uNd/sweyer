...
// ///
// /// [SMMScaffoldState] uses this to seamlessly change transition animations
...
// /// Geometry information for [SMMScaffold] components after layout is finished.
// ///
// /// To get a [ValueNotifier] for the scaffold geometry of a given
// /// [BuildContext], use [SMMScaffold.geometryOf].
// ///
// /// The SMMScaffoldGeometry is only available during the paint phase, because
// /// its value is computed during the animation and layout phases prior to painting.
// ///
// /// For an example of using the [SMMScaffoldGeometry], see the [BottomAppBar],
// /// which uses the [SMMScaffoldGeometry] to paint a notch around the
// /// [FloatingActionButton].
// ///
// /// For information about the [SMMScaffold]'s geometry that is used while laying
// /// out the [FloatingActionButton], see [SMMScaffoldPrelayoutGeometry].
// @immutable
// class SMMScaffoldGeometry {
//   /// Create an object that describes the geometry of a [SMMScaffold].
//   const SMMScaffoldGeometry({
//     this.bottomNavigationBarTop,
//     this.floatingActionButtonArea,
//   });

//   /// The distance from the [SMMScaffold]'s top edge to the top edge of the
//   /// rectangle in which the [SMMScaffold.bottomNavigationBar] bar is laid out.
//   ///
//   /// Null if [SMMScaffold.bottomNavigationBar] is null.
//   final double bottomNavigationBarTop;

//   /// The [SMMScaffold.floatingActionButton]'s bounding rectangle.
//   ///
//   /// This is null when there is no floating action button showing.
//   final Rect floatingActionButtonArea;

//   SMMScaffoldGeometry _scaleFloatingActionButton(double scaleFactor) {
//     if (scaleFactor == 1.0)
//       return this;

//     if (scaleFactor == 0.0) {
//       return SMMScaffoldGeometry(
...
//   /// Creates a copy of this [SMMScaffoldGeometry] but with the given fields replaced with
//   /// the new values.
//   SMMScaffoldGeometry copyWith({
...
// class _SMMScaffoldGeometryNotifier extends ChangeNotifier implements ValueListenable<SMMScaffoldGeometry> {
//   _SMMScaffoldGeometryNotifier(this.geometry, this.context)
//     : assert (context != null);

//   final BuildContext context;
//   double floatingActionButtonScale;
//   SMMScaffoldGeometry geometry;

//   @override
//   SMMScaffoldGeometry get value {
//     assert(() {
//       final RenderObject renderObject = context.findRenderObject();
//       if (renderObject == null || !renderObject.owner.debugDoingPaint)
//         throw FlutterError(
//             'SMMScaffold.geometryOf() must only be accessed during the paint phase.\n'
//             'The SMMScaffoldGeometry is only available during the paint phase, because\n'
//             'its value is computed during the animation and layout phases prior to painting.'
//         );
//       return true;
...
// // Used to communicate the height of the SMMScaffold's bottomNavigationBar and
// // persistentFooterButtons to the LayoutBuilder which builds the SMMScaffold's body.
// //
// // SMMScaffold expects a _BodyBoxConstraints to be passed to the _BodyBuilder
// // widget's LayoutBuilder, see _SMMScaffoldLayout.performLayout(). The BoxConstraints
...
// // Used when SMMScaffold.extendBody is true to wrap the scaffold's body in a MediaQuery
...
// // The constraints parameter is constructed in_SMMScaffoldLayout.performLayout().
...
// class _SMMScaffoldLayout extends MultiChildLayoutDelegate {
//   _SMMScaffoldLayout({
...
//   final _SMMScaffoldGeometryNotifier geometryNotifier;
...
//     if (hasChild(_SMMScaffoldSlot.appBar)) {
//       appBarHeight = layoutChild(_SMMScaffoldSlot.appBar, fullWidthConstraints).height;
//       contentTop = extendBodyBehindAppBar ? 0.0 : appBarHeight;
//       positionChild(_SMMScaffoldSlot.appBar, Offset.zero);
//     }

//     double bottomNavigationBarTop;
//     if (hasChild(_SMMScaffoldSlot.bottomNavigationBar)) {
//       final double bottomNavigationBarHeight = layoutChild(_SMMScaffoldSlot.bottomNavigationBar, fullWidthConstraints).height;
//       bottomWidgetsHeight += bottomNavigationBarHeight;
//       bottomNavigationBarTop = math.max(0.0, bottom - bottomWidgetsHeight);
//       positionChild(_SMMScaffoldSlot.bottomNavigationBar, Offset(0.0, bottomNavigationBarTop));
//     }

//     if (hasChild(_SMMScaffoldSlot.persistentFooter)) {
//       final BoxConstraints footerConstraints = BoxConstraints(
//         maxWidth: fullWidthConstraints.maxWidth,
//         maxHeight: math.max(0.0, bottom - bottomWidgetsHeight - contentTop),
//       );
//       final double persistentFooterHeight = layoutChild(_SMMScaffoldSlot.persistentFooter, footerConstraints).height;
//       bottomWidgetsHeight += persistentFooterHeight;
//       positionChild(_SMMScaffoldSlot.persistentFooter, Offset(0.0, math.max(0.0, bottom - bottomWidgetsHeight)));
//     }
...
//     if (hasChild(_SMMScaffoldSlot.body)) {
...
//       );
//       layoutChild(_SMMScaffoldSlot.body, bodyConstraints);
//       positionChild(_SMMScaffoldSlot.body, Offset(0.0, contentTop));
//     }
...
//     if (hasChild(_SMMScaffoldSlot.bodyScrim)) {
//       final BoxConstraints bottomSheetScrimConstraints = BoxConstraints(
//         maxWidth: fullWidthConstraints.maxWidth,
//         maxHeight: contentBottom,
//       );
//       layoutChild(_SMMScaffoldSlot.bodyScrim, bottomSheetScrimConstraints);
//       positionChild(_SMMScaffoldSlot.bodyScrim, Offset.zero);
//     }

//     // Set the size of the SnackBar early if the behavior is fixed so
//     // the FAB can be positioned correctly.
//     if (hasChild(_SMMScaffoldSlot.snackBar) && !isSnackBarFloating) {
//       snackBarSize = layoutChild(_SMMScaffoldSlot.snackBar, fullWidthConstraints);
//     }

//     if (hasChild(_SMMScaffoldSlot.bottomSheet)) {
//       final BoxConstraints bottomSheetConstraints = BoxConstraints(
//         maxWidth: fullWidthConstraints.maxWidth,
//         maxHeight: math.max(0.0, contentBottom - contentTop),
//       );
//       bottomSheetSize = layoutChild(_SMMScaffoldSlot.bottomSheet, bottomSheetConstraints);
//       positionChild(_SMMScaffoldSlot.bottomSheet, Offset((size.width - bottomSheetSize.width) / 2.0, contentBottom - bottomSheetSize.height));
//     }

//     Rect floatingActionButtonRect;
//     if (hasChild(_SMMScaffoldSlot.floatingActionButton)) {
//       final Size fabSize = layoutChild(_SMMScaffoldSlot.floatingActionButton, looseConstraints);
...
//       );
//       positionChild(_SMMScaffoldSlot.floatingActionButton, fabOffset);
//       floatingActionButtonRect = fabOffset & fabSize;
//     }

//     if (hasChild(_SMMScaffoldSlot.snackBar)) {
...
//         : contentBottom;
//       positionChild(_SMMScaffoldSlot.snackBar, Offset(0.0, snackBarYOffsetBase - snackBarSize.height));
//     }

//     if (hasChild(_SMMScaffoldSlot.statusBar)) {
//       layoutChild(_SMMScaffoldSlot.statusBar, fullWidthConstraints.tighten(height: minInsets.top));
//       positionChild(_SMMScaffoldSlot.statusBar, Offset.zero);
//     }

//     if (hasChild(_SMMScaffoldSlot.drawer)) {
//       layoutChild(_SMMScaffoldSlot.drawer, BoxConstraints.tight(size));
//       positionChild(_SMMScaffoldSlot.drawer, Offset.zero);
//     }

//     if (hasChild(_SMMScaffoldSlot.endDrawer)) {
//       layoutChild(_SMMScaffoldSlot.endDrawer, BoxConstraints.tight(size));
//       positionChild(_SMMScaffoldSlot.endDrawer, Offset.zero);
//     }
...
//   @override
//   bool shouldRelayout(_SMMScaffoldLayout oldDelegate) {
...
// /// * Motion animations, which are triggered by the [SMMScaffold]
...
// /// [SMMScaffoldState] for the current [BuildContext] via [SMMScaffold.of] and use the
// /// [SMMScaffoldState.showSnackBar] and [SMMScaffoldState.showBottomSheet] functions.
// ///
// /// {@tool snippet --template=stateful_widget_material}
// /// This example shows a [SMMScaffold] with a [body] and [FloatingActionButton].
// /// The [body] is a [Text] placed in a [Center] in order to center the text
// /// within the [SMMScaffold]. The [FloatingActionButton] is connected to a
// /// callback that increments a counter.
// ///
// /// ![The SMMScaffold has a white background with a blue AppBar at the top. A blue FloatingActionButton is positioned at the bottom right corner of the SMMScaffold.](https://flutter.github.io/assets-for-api-docs/assets/material/scaffold.png)
// ///
// /// ```dart
// /// int _count = 0;
// ///
...
// ///
// /// {@tool snippet --template=stateful_widget_material}
// /// This example shows a [SMMScaffold] with a blueGrey [backgroundColor], [body]
// /// and [FloatingActionButton]. The [body] is a [Text] placed in a [Center] in
// /// order to center the text within the [SMMScaffold]. The [FloatingActionButton]
...
// ///
// /// {@tool snippet --template=stateful_widget_material}
// /// This example shows a [SMMScaffold] with an [AppBar], a [BottomAppBar] and a
// /// [FloatingActionButton]. The [body] is a [Text] placed in a [Center] in order
// /// to center the text within the [SMMScaffold]. The [FloatingActionButton] is
...
// /// {@end-tool}
// ///
// /// ## SMMScaffold layout, the keyboard, and display "notches"
// ///
...
// /// the device's keyboard appears the SMMScaffold's ancestor [MediaQuery]
// /// widget's [MediaQueryData.viewInsets] changes and the SMMScaffold will
...
// /// ### Nested SMMScaffolds
// ///
// /// The SMMScaffold was designed to be the single top level container for
...
// ///    bottom of the app using the [SMMScaffoldState.showSnackBar] method.
// ///  * [BottomSheet], which is an overlay typically shown near the bottom of the
// ///    app. A bottom sheet can either be persistent, in which case it is shown
// ///    using the [SMMScaffoldState.showBottomSheet] method, or modal, in which case
// ///    it is shown using the [showModalBottomSheet] function.
// ///  * [SMMScaffoldState], which is the state associated with this widget.
// ///  * <https://material.io/design/layout/responsive-layout-grid.html>
// class SMMScaffold extends StatefulWidget {
...
//   /// is specified, then the [body] extends to the bottom of the SMMScaffold,
...
//   ///
//   /// If null, the [SMMScaffoldState] will use the default location, [FloatingActionButtonLocation.endFloat].
//   final FloatingActionButtonLocation floatingActionButtonLocation;

//   /// Animator to move the [floatingActionButton] to a new [floatingActionButtonLocation].
//   ///
//   /// If null, the [SMMScaffoldState] will use the default animator, [FloatingActionButtonAnimator.scaling].
...
//   /// [SMMScaffoldState.openDrawer] function.
//   ///
//   /// Typically a [Drawer].
//   final Widget drawer;
...
//   ///
//   /// In the uncommon case that you wish to open the drawer manually, use the
//   /// [SMMScaffoldState.openEndDrawer] function.
//   ///
//   /// Typically a [Drawer].
...
//   /// The color of the [Material] widget that underlies the entire SMMScaffold.
//   ///
...
//   /// visible, it must be closed before building the SMMScaffold with a new
//   /// [bottomSheet].
//   ///
...
//   ///   Widget build(BuildContext context) {
//   ///     return MaterialApp(
//   ///       title: 'Flutter Code Sample for SMMScaffold.of.',
//   ///       theme: ThemeData(
//   ///         primarySwatch: Colors.blue,
//   ///       ),
//   ///       home: SMMScaffold(
//   ///         body: MySMMScaffoldBody(),
//   ///         appBar: AppBar(title: Text('SMMScaffold.of Example')),
//   ///       ),
//   ///       color: Colors.white,
//   ///     );
//   ///   }
...
//   ///
//   /// ```dart
//   /// class MySMMScaffoldBody extends StatelessWidget {
//   ///   @override
//   ///   Widget build(BuildContext context) {
//   ///     return Center(
//   ///       child: RaisedButton(
...
//   ///         onPressed: () {
//   ///           SMMScaffold.of(context).showSnackBar(
//   ///             SnackBar(
...
//   ///       // can refer to the SMMScaffold with SMMScaffold.of().
//   ///       builder: (BuildContext context) {
//   ///         return Center(
//   ///           child: RaisedButton(
//   ///             child: Text('SHOW A SNACKBAR'),
//   ///             onPressed: () {
//   ///               SMMScaffold.of(context).showSnackBar(SnackBar(
//   ///                 content: Text('Have a snack!'),
//   ///               ));
//   ///             },
//   ///           ),
...
//   /// [SMMScaffold]. In this solution, you would have an outer widget that creates
//   /// the [SMMScaffold] populated by instances of your new inner widgets, and then
//   /// in these inner widgets you would use [SMMScaffold.of].
//   ///
//   /// A less elegant but more expedient solution is assign a [GlobalKey] to the
//   /// [SMMScaffold], then use the `key.currentState` property to obtain the
//   /// [SMMScaffoldState] rather than using the [SMMScaffold.of] function.
//   ///
//   /// If there is no [SMMScaffold] in scope, then this will throw an exception.
//   /// To return null if there is no [SMMScaffold], then pass `nullOk: true`.
//   static SMMScaffoldState of(BuildContext context, { bool nullOk = false }) {
//     assert(nullOk != null);
//     assert(context != null);
//     final SMMScaffoldState result = context.findAncestorStateOfType<SMMScaffoldState>();
//     if (nullOk || result != null)
//       return result;
//     throw FlutterError.fromParts(<DiagnosticsNode>[
//       ErrorSummary(
//         'SMMScaffold.of() called with a context that does not contain a SMMScaffold.'
//       ),
//       ErrorDescription(
//         'No SMMScaffold ancestor could be found starting from the context that was passed to SMMScaffold.of(). '
//         'This usually happens when the context provided is from the same StatefulWidget as that '
//         'whose build function actually creates the SMMScaffold widget being sought.'
//       ),
//       ErrorHint(
//         'There are several ways to avoid this problem. The simplest is to use a Builder to get a '
//         'context that is "under" the SMMScaffold. For an example of this, please see the '
//         'documentation for SMMScaffold.of():\n'
//         '  https://api.flutter.dev/flutter/material/SMMScaffold/of.html'
//       ),
//       ErrorHint(
//         'A more efficient solution is to split your build function into several widgets. This '
//         'introduces a new context from which you can obtain the SMMScaffold. In this solution, '
//         'you would have an outer widget that creates the SMMScaffold populated by instances of '
//         'your new inner widgets, and then in these inner widgets you would use SMMScaffold.of().\n'
//         'A less elegant but more expedient solution is assign a GlobalKey to the SMMScaffold, '
//         'then use the key.currentState property to obtain the SMMScaffoldState rather than '
//         'using the SMMScaffold.of() function.'
//       ),
//       context.describeElement('The context used was')
//     ]);
//   }

//   /// Returns a [ValueListenable] for the [SMMScaffoldGeometry] for the closest
//   /// [SMMScaffold] ancestor of the given context.
//   ///
...
//   /// paint pass.
//   ///
//   /// The closest [SMMScaffold] ancestor for the context might change, e.g when
//   /// an element is moved from one scaffold to another. For [StatefulWidget]s
//   /// using this listenable, a change of the [SMMScaffold] ancestor will
//   /// trigger a [State.didChangeDependencies].
//   ///
//   /// A typical pattern for listening to the scaffold geometry would be to
//   /// call [SMMScaffold.geometryOf] in [State.didChangeDependencies], compare the
//   /// return value with the previous listenable, if it has changed, unregister
//   /// the listener, and register a listener to the new [SMMScaffoldGeometry]
//   /// listenable.
//   static ValueListenable<SMMScaffoldGeometry> geometryOf(BuildContext context) {
//     final _SMMScaffoldScope scaffoldScope = context.dependOnInheritedWidgetOfExactType<_SMMScaffoldScope>();
//     if (scaffoldScope == null)
//       throw FlutterError.fromParts(<DiagnosticsNode>[
//         ErrorSummary(
//           'SMMScaffold.geometryOf() called with a context that does not contain a SMMScaffold.'
//         ),
//         ErrorDescription(
//           'This usually happens when the context provided is from the same StatefulWidget as that '
//           'whose build function actually creates the SMMScaffold widget being sought.'
...
//           'introduces a new context from which you can obtain the SMMScaffold. In this solution, '
//           'you would have an outer widget that creates the SMMScaffold populated by instances of '
//           'your new inner widgets, and then in these inner widgets you would use SMMScaffold.geometryOf().',
//         ),
//         context.describeElement('The context used was')
//       ]);
...
//   /// Whether the SMMScaffold that most tightly encloses the given context has a
//   /// drawer.
//   ///
...
//   /// See also:
//   ///
//   ///  * [SMMScaffold.of], which provides access to the [SMMScaffoldState] object as a
//   ///    whole, from which you can show snackbars, bottom sheets, and so forth.
//   static bool hasDrawer(BuildContext context, { bool registerForUpdates = true }) {
//     assert(registerForUpdates != null);
//     assert(context != null);
//     if (registerForUpdates) {
//       final _SMMScaffoldScope scaffold = context.dependOnInheritedWidgetOfExactType<_SMMScaffoldScope>();
//       return scaffold?.hasDrawer ?? false;
//     } else {
//       final SMMScaffoldState scaffold = context.findAncestorStateOfType<SMMScaffoldState>();
//       return scaffold?.hasDrawer ?? false;
//     }
//   }

//   @override
//   SMMScaffoldState createState() => SMMScaffoldState();
// }

// /// State for a [SMMScaffold].
// ///
// /// Can display [SnackBar]s and [BottomSheet]s. Retrieve a [SMMScaffoldState] from
// /// the current [BuildContext] using [SMMScaffold.of].
// class SMMScaffoldState extends State<SMMScaffold> with TickerProviderStateMixin {

//   // DRAWER API

//   final GlobalKey<SMMDrawerControllerState> _drawerKey = GlobalKey<SMMDrawerControllerState>();
//   final GlobalKey<SMMDrawerControllerState> _endDrawerKey = GlobalKey<SMMDrawerControllerState>();

//   /// Whether this scaffold has a non-null [SMMScaffold.appBar].
//   bool get hasAppBar => widget.appBar != null;
//   /// Whether this scaffold has a non-null [SMMScaffold.drawer].
//   bool get hasDrawer => widget.drawer != null;
//   /// Whether this scaffold has a non-null [SMMScaffold.endDrawer].
//   bool get hasEndDrawer => widget.endDrawer != null;
//   /// Whether this scaffold has a non-null [SMMScaffold.floatingActionButton].
//   bool get hasFloatingActionButton => widget.floatingActionButton != null;

//   double _appBarMaxHeight;
//   /// The max height the [SMMScaffold.appBar] uses.
//   ///
...
//   /// Whether the [SMMScaffold.drawer] is opened.
//   ///
//   /// See also:
//   ///
//   ///  * [SMMScaffoldState.openDrawer], which opens the [SMMScaffold.drawer] of a
//   ///    [SMMScaffold].
//   bool get isDrawerOpen => _drawerOpened;

//   /// Whether the [SMMScaffold.endDrawer] is opened.
//   ///
//   /// See also:
//   ///
//   ///  * [SMMScaffoldState.openEndDrawer], which opens the [SMMScaffold.endDrawer] of
//   ///    a [SMMScaffold].
...
//   ///
//   /// If the scaffold has a non-null [SMMScaffold.drawer], this function will cause
//   /// the drawer to begin its entrance animation.
//   ///
//   /// Normally this is not needed since the [SMMScaffold] automatically shows an
//   /// appropriate [IconButton], and handles the edge-swipe gesture, to show the
//   /// drawer.
//   ///
//   /// To close the drawer once it is open, use [Navigator.pop].
//   ///
//   /// See [SMMScaffold.of] for information about how to obtain the [SMMScaffoldState].
//   void openDrawer() {
...
//   ///
//   /// If the scaffold has a non-null [SMMScaffold.endDrawer], this function will cause
...
//   final Queue<SMMScaffoldFeatureController<SnackBar, SnackBarClosedReason>> _snackBars = Queue<SMMScaffoldFeatureController<SnackBar, SnackBarClosedReason>>();
...
//   /// or call [SMMScaffoldFeatureController.close] on the returned
//   /// [SMMScaffoldFeatureController]. To remove a [SnackBar] suddenly (without an
//   /// animation), use [removeCurrentSnackBar].
//   ///
//   /// See [SMMScaffold.of] for information about how to obtain the [SMMScaffoldState].
//   SMMScaffoldFeatureController<SnackBar, SnackBarClosedReason> showSnackBar(SnackBar snackbar) {
...
//     }
//     SMMScaffoldFeatureController<SnackBar, SnackBarClosedReason> controller;
//     controller = SMMScaffoldFeatureController<SnackBar, SnackBarClosedReason>._(
...
//       // will not be added to the SMMScaffold's appbar and the bottom sheet will not
...
//         throw FlutterError(
//           'SMMScaffold.bottomSheet cannot be specified while a bottom sheet'
//           'displayed with showBottomSheet() is still visible.\n'
//           'Rebuild the SMMScaffold with a null bottomSheet before calling showBottomSheet().'
//         );
//       }
//       return true;
//     }());
...
//   /// Shows a material design bottom sheet in the nearest [SMMScaffold]. To show
//   /// a persistent bottom sheet, use the [SMMScaffold.bottomSheet].
//   ///
...
//   /// [ModalRoute] and a back button is added to the app bar of the [SMMScaffold]
//   /// that closes the bottom sheet.
//   ///
//   /// To create a persistent bottom sheet that is not a [LocalHistoryEntry] and
//   /// does not add a back button to the enclosing SMMScaffold's app bar, use the
//   /// [SMMScaffold.bottomSheet] constructor parameter.
//   ///
//   /// A persistent bottom sheet shows information that supplements the primary
//   /// content of the app. A persistent bottom sheet remains visible even when
//   /// the user interacts with other parts of the app.
...
//   ///       onPressed: () {
//   ///         SMMScaffold.of(context).showBottomSheet<void>(
//   ///           (BuildContext context) {
//   ///             return Container(
//   ///               height: 200,
//   ///               color: Colors.amber,
...
//   ///    sheet.
//   ///  * [SMMScaffold.of], for information about how to obtain the [SMMScaffoldState].
...
//   /// [SMMScaffold.floatingActionButton].
...
//   /// [SMMScaffold.floatingActionButton].  This value must not be null.
...
//   /// Shows the [SMMScaffold.floatingActionButton].
...
//   _SMMScaffoldGeometryNotifier _geometryNotifier;
...
//   void initState() {
//     super.initState();
//     _geometryNotifier = _SMMScaffoldGeometryNotifier(const SMMScaffoldGeometry(), context);
...
//   @override
//   void didUpdateWidget(SMMScaffold oldWidget) {
...
//           ),
//         ),
//         _SMMScaffoldSlot.persistentFooter,
//         removeLeftPadding: false,
//         removeTopPadding: true,
//         removeRightPadding: false,
//         removeBottomPadding: false,
...
//         _SMMScaffoldSlot.bottomNavigationBar,
//         removeLeftPadding: false,
//         removeTopPadding: true,
//         removeRightPadding: false,
//         removeBottomPadding: false,
...
//       ),
//       _SMMScaffoldSlot.floatingActionButton,
//       removeLeftPadding: true,
//       removeTopPadding: true,
//       removeRightPadding: true,
//       removeBottomPadding: true,
...
//     // The minimum insets for contents of the SMMScaffold to keep visible.
...
// /// An interface for controlling a feature of a [SMMScaffold].
// ///
// /// Commonly obtained from [SMMScaffoldState.showSnackBar] or [SMMScaffoldState.showBottomSheet].
// class SMMScaffoldFeatureController<T extends Widget, U> {
//   const SMMScaffoldFeatureController._(this._widget, this._completer, this.close, this.setState);
//   final T _widget;
...
//     final SMMScaffoldState scaffold = SMMScaffold.of(context);
...
//     }
//     // If the SMMScaffold.bottomSheet != null, we're a persistent bottom sheet.
...
// /// A [SMMScaffoldFeatureController] for standard bottom sheets.
// ///
// /// This is the type of objects returned by [SMMScaffoldState.showBottomSheet].
// ///
...
// /// [SMMScaffold.bottomSheet].
// class PersistentBottomSheetController<T> extends SMMScaffoldFeatureController<_StandardBottomSheet, T> {
...
// class _SMMScaffoldScope extends InheritedWidget {
//   const _SMMScaffoldScope({
...
//   @override
//   bool updateShouldNotify(_SMMScaffoldScope oldWidget) {
